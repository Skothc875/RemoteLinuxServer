TelegramLinuxServer version 1.2A by Skothc875
documentation for TLS v1.2A
...
Бот ещё не стабилен, отпровляя отчёты вы делаете его лучше. Спасибо что используете этот софт.
...
The bot is not stable yet, by sending reports you make it better. Thanks for using this software.
